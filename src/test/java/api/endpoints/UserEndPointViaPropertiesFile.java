...
public class UserEndPointViaPropertiesFile {
 ...
 static	ResourceBundle getURL(){
	...
	public static Response createUser(User payload) {//User payload(user.java) not been developed yet (getters and setters)
